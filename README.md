...
2. New contract → paste [`contracts/reputation_oracle.py`](contracts/reputation_oracle.py)
3. Deploy
4. Test:
   - `link_identity("your_github_handle")`
   - `request_score()` (wait 30s-2min for LLM + consensus)
   - `read_my_score()`
